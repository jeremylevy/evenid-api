...
module.exports = function (credentialsMedium) {
    ...
    describe('POST /oauth/token (Authorization code) (Without client secret in ' 
        ...
        it('responds with HTTP code 200 and '
           + 'tokens when using localhost uri', function (done) {
        ...
        it('responds with HTTP code 200 and tokens when '
           + 'using `urn:ietf:wg:oauth:2.0:oob:auto` uri', function (done) {
