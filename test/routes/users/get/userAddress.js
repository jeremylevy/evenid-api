...
describe('GET /users/:user_id/addresses/:address_id', function () {
    ...
    it('responds with HTTP code 403 and `access_denied` error when '
       + 'non-app token try to get user address', function (done) {
    ...
    it('responds with HTTP code 403 and `access_denied` error when '
       + 'user try to get user address which does not belong to him', function (done) {
    ...
    it('responds with HTTP code 403 and `access_denied` error when '
       + 'attempt to get invalid address', function (done) {
    ...
    it('responds with HTTP code 200 and address when '
       + 'getting valid address', function (done) {
