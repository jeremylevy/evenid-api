...
describe('GET /clients/:client_id/hooks/:hook_id', function () {
    ...
    it('responds with HTTP code 403 and `access_denied` error when '
       + 'non-developer try to get client hook', function (done) {
    ...
    it('responds with HTTP code 403 and `access_denied` error when '
       + 'developer try to get client hook which does not belong to him', function (done) {
    ...
    it('responds with HTTP code 404 and `not_found` error error when attempt '
       + 'to modify client hook which does not exist', function (done) {
    ...
    it('responds with HTTP code 200 and valid hook infos when '
       + 'developer get client hook which belongs to him', function (done) {
